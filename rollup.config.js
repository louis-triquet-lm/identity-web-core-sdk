...
function createBundle({ file, format, name, external, withUglify = false }) {
  return {
    ...
    onwarn: message => {
      ...
      if (message.code === 'CIRCULAR_DEPENDENCY' && message.importer === 'node_modules/space-lift/es/option/index.js')
        return
...
export default [
  ...
  //createBundle({ file: '../module/src/utils/identity-core.js', format: 'umd', name: 'reach5' })
  createBundle({ file: '../module/src/utils/identity-core.js', format: 'cjs' })
